<%@ Page Title="未入库到货单" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="DateCheck1.aspx.cs" Inherits="WorkForms_DateCheck1" %>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table border="1" cellpadding="0" cellspacing="0" class="style1" frame="Border" 
                ...
                <tr>
                    ...
                    <td align="center">
                        到货单单据号:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            ...
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="单据号" HeaderText="到货单单据号" />
                        <asp:BoundField DataField="日期" HeaderText="日期" DataFormatString="{0:yyyy-M-d}"  SortExpression="日期"/>
                        ...
                        <asp:TemplateField HeaderText="未入库天数"  SortExpression="天数">
                            <ItemTemplate>
                                经过 <asp:Label ID="tianshu" runat="server" Text='<%# Eval("天数")%>' Font-Size="Large" ForeColor="Red"> </asp:Label> 天未入库
                            </ItemTemplate>                           
                        </asp:TemplateField>
