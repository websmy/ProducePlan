...
public partial class WorkForms_Mom4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            部门 = Request.QueryString["id"];
            ViewState["部门"] = 部门;

            p1 = Request.QueryString["p1"];
            ViewState["mothday"] = p1;
            ...
            //SQLHelperOA.ExecuteSql("delete from SetColor where cSOCode='" + mocode + "' ");
    ...
    protected void Bind()
    {
      ...
      "  ";
        ...
        string sqlAdded1 = "    where     zuiwaimian.部门='" + ViewState["部门"] + "'   " +
                       "   ";

        string sql = sqlFirst2 + sqlAdded + sqlAdded1;
