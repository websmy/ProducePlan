...
public partial class WorkForms_DateCheck : System.Web.UI.Page
{
    ...
    protected void Bind(bool isFirstPage)
    {
        ...
        string sql =
            " select * from (select substring(inv.[cInvcCode],1,4) 大分类编码 , inv.[cInvcCode] 分类编码,a.dPODate 订单日期,b.cupsocode 销售订单号,a.cpoid 采购订单号,b.[cInvCode] 存货编码, inv.cInvName 存货名称,isnull(b.cDefine37,b.dArriveDate) 计划到货日期,b.iQuantity 订单数量,isnull(b.iarrQty,0) 累计到货数量, datediff(day,getdate(),isnull(b.cDefine37,b.dArriveDate)) as 天数" +
            " from [PO_Podetails] b left join [PO_Pomain] a  on a.poid=b.poid left join [Inventory] inv on inv.[cInvCode]=b.[cInvCode]                                                                                                       " +
            " where b.iQuantity > ISNULL(b.iarrQty,0)  and a.dPODate>'2015-01-01' and len(inv.[cInvcCode])>=4 and b.cbCloser is null  and                                                                                                                                       " +
            " (left(inv.[cInvcCode],4)='0101'                                                                                                                                                                                                " +
            " or left(inv.[cInvcCode],4)='0102'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0201'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0202'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0203'                                                                                                                                                                                              " +

            " or left(inv.[cInvcCode],4)='0105'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0107'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0108'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0112'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0113'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0114'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0119'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0120'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0121'                                                                                                                                                                                              " +

            " or left(inv.[cInvcCode],8)='02020307'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],8)='02020302'                                                                                                                                                                                              " +

            " or left(inv.[cInvcCode],4)='0313'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0314'                                                                                                                                                                                              " +


            " or left(inv.[cInvcCode],4)='0110'                                                                                                                                                                                              " +
            " or left(inv.[cInvcCode],4)='0106')                                                                                                                                                                                             " +
            //" and  datediff(day,getdate(),b.cDefine37)<=4                                                                                                                                                                                  " +
            "                                                                                                                                                                                                                                " +
            " union    all                                                                                                                                                                                                                      " +
            " select substring(inv.[cInvcCode],1,4) 大分类编码 ,inv.[cInvcCode] 分类编码,a.dPODate 订单日期,b.cupsocode 销售订单号,a.cpoid 采购订单号,b.[cInvCode] 存货编码, inv.cInvName 存货名称,ISNULL(b.cDefine37, b.dArriveDate) 计划到货日期,b.iQuantity 订单数量,isnull(b.iarrQty,0) 累计到货数量 , datediff(day,getdate(),isnull(b.cDefine37,b.dArriveDate)) as 天数              " +
            " from [PO_Podetails] b left join [PO_Pomain] a  on a.poid=b.poid left join [Inventory] inv on inv.[cInvCode]=b.[cInvCode]                                                                                                       " +
            " where b.iQuantity > ISNULL(b.iarrQty,0)  and a.dPODate>'2015-01-01' and len(inv.[cInvcCode])>=4 and b.cbCloser is null and                                                                                                                                       " +
            " (left(inv.[cInvcCode],4)='0104')                                                                                                                                                                                               " +
            //" and  datediff(day,getdate(),b.cDefine37)<=5                                                                                                                                                                                  " +
            "                                                                                                                                                                                                                                " +
            " union     all                                                                                                                                                                                                                     " +
            "                                                                                                                                                                                                                                " +
            " select substring(inv.[cInvcCode],1,4) 大分类编码 ,inv.[cInvcCode] 分类编码,a.dPODate 订单日期,b.cupsocode 销售订单号,a.cpoid 采购订单号,b.[cInvCode] 存货编码, inv.cInvName 存货名称,ISNULL(b.cDefine37, b.dArriveDate) 计划到货日期,b.iQuantity 订单数量,isnull(b.iarrQty,0) 累计到货数量 , datediff(day,getdate(),isnull(b.cDefine37,b.dArriveDate)) as 天数             " +
            " from [PO_Podetails] b left join [PO_Pomain] a  on a.poid=b.poid left join [Inventory] inv on inv.[cInvCode]=b.[cInvCode]                                                                                                       " +
            " where b.iQuantity > ISNULL(b.iarrQty,0)  and a.dPODate>'2015-01-01' and len(inv.[cInvcCode])>=4 and b.cbCloser is null and                                                                                                                                       " +
            " (left(inv.[cInvcCode],4)='0103')                                                                                                                                                                                               " +
            //" and  datediff(day,getdate(),b.cDefine37)<=7                                                                                                                                                                                  " +
            ") as bigTable                                                                                                                                                                     ";
sql += " where 1=1 ";

        sql +=
            "and  ((                                                                      " +
            " substring(分类编码,1,4)!='0101'                                 " +
            " and substring(分类编码,1,4)!='0102'                          " +
            " and substring(分类编码,1,4)!='0106'                          " +
            " and substring(分类编码,1,4)!='0120'                          " +
            " )                                                                              " +
            " or                                                                            " +
            " (                                                                              " +
            " (                                                                              " +
            " substring(分类编码,1,4)='0101'                                  " +
            " or substring(分类编码,1,4)='0102'                              " +
            " or substring(分类编码,1,4)='0106'                              " +
            " or substring(分类编码,1,4)='0120'                              " +
            " )                                                                              " +
            " and                                                                         " +
            " (                                                                              " +
            " 累计到货数量 < 订单数量-(订单数量*0.9)                     " +
            " )                                                                              " +
            " )  )                                                                            ";

        if (!"".Equals(TextBox1.Text.Trim()))
        {
            sql += " and bigTable.采购订单号='" + TextBox1.Text.Trim() + "'";
        }
        //============================
        if (!"".Equals(txtStartDate.Text.Trim()))
        {
            sql += " and bigTable.订单日期>='" + txtStartDate.Text.Trim() + "'";
        }

        if (!"".Equals(txtEndDate.Text.Trim()))
        {
            sql += " and bigTable.订单日期<='" + txtEndDate.Text.Trim() + "'";
        }

        if (!"".Equals(txtStartDate.Text.Trim()) && !"".Equals(txtEndDate.Text.Trim()))
        {
            sql += " and bigTable.订单日期 >='" + txtStartDate.Text + "' and bigTable.订单日期 <='" + txtEndDate.Text + "' ";
        }
        //================================
