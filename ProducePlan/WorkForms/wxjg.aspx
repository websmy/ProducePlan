<%@ Page Title="外协加工" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="wxjg.aspx.cs" Inherits="WorkForms_wxjg" %>
...
　　        function openwin2(name, winname, id, iWidth, iHeight, p1, p2, p3, p4, p5, p6, p7, MoId, SortSeq, MoDId, p8, p9) {
    ...
    <h2 align="center">
        &nbsp;<asp:Label ID="Label1" runat="server" Text="外协加工"></asp:Label>
    </h2>
    <p>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        当前节点：<asp:DropDownList ID="DropDownList4" runat="server">
                            ...
                            <asp:ListItem Value="1">正在进行</asp:ListItem>
                            <asp:ListItem Value="2">已经结束</asp:ListItem>
                        </asp:DropDownList>
            ...
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="cannotsee" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" Value='<%# Eval("autoid")%>' ID="autoid" />
                                  <asp:HiddenField runat="server" Value='<%# Eval("外协工序1")%>' ID="外协工序1" />
                                <asp:HiddenField runat="server" Value='<%# Eval("外协工序2")%>' ID="外协工序2" />
                        ...
                        <asp:BoundField DataField="发货日期" HeaderText="日期" DataFormatString="{0:yyyy-MM-dd}" />
                        <asp:BoundField DataField="客户" HeaderText="客户" />
                        <asp:BoundField DataField="部件编码" HeaderText="存货编码" />
                       ...
                       <%-- <asp:TemplateField HeaderText="承运商">
                        ...
                        <asp:BoundField DataField="更新者" HeaderText="更新者" />
