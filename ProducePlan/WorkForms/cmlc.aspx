<%@ Page Title="车间下料" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="cmlc.aspx.cs" Inherits="WorkForms_cmlc" %>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table border="1" cellpadding="0" cellspacing="0" class="style1" frame="Border">
                <tr>
                    ...
                    <td align="center"> 发货日期 从<asp:TextBox ID="txtStartDate" runat="server"></asp:TextBox>
                        ...
                        当前节点：<asp:DropDownList ID="DropDownList4" runat="server">
                            ...
                            <asp:ListItem Value="1">1:销售部</asp:ListItem>
                            <asp:ListItem Value="2">2:财务部</asp:ListItem>
                            <asp:ListItem Value="3">3:用车主管</asp:ListItem>
                            <asp:ListItem Value="4">4:门卫北</asp:ListItem>
                            <asp:ListItem Value="5">5:门卫南</asp:ListItem>
                            <asp:ListItem Value="6">6:用车主管实际结算</asp:ListItem>
                            <asp:ListItem Value="7">7:财务审单</asp:ListItem>
                        </asp:DropDownList>
