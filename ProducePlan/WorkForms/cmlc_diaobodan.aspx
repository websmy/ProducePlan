<%@ Page Title="车间下料" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="cmlc_diaobodan.aspx.cs" Inherits="WorkForms_cmlc_diaobodan" %>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        当前节点：<asp:DropDownList ID="DropDownList4" runat="server">
                            ...
                            <asp:ListItem Value="7">7:采购结算运费</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="cannotsee" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" Value='<%# Eval("单据类型")%>' ID="单据类型" />
                                <asp:HiddenField runat="server" Value='<%# Eval("autoid")%>' ID="autoid" />
                                
                                <asp:HiddenField runat="server" Value='<%# Eval("cmlcautoid")%>' ID="cmlcautoid" />

                                
                                   <asp:HiddenField runat="server" Value='<%# Eval("id")%>' ID="id" />
                                   
                                   <asp:HiddenField runat="server" Value='<%# Eval("数量")%>' ID="数量" />
                        ...
                        <asp:BoundField DataField="数量" HeaderText="数量" />
                         ...
                         <asp:TemplateField HeaderText="结算数量">
                            <ItemTemplate>
                                <asp:TextBox ID="结算数量" runat="server" Text='<%# Bind("结算数量") %>' ReadOnly="True" Width="50px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="* 必添"
                                    ControlToValidate="结算数量" InitialValue="" ForeColor="Red" Enabled="False"></asp:RequiredFieldValidator>
                            </ItemTemplate>
                        </asp:TemplateField>
