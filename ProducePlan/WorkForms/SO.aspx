<%@ Page Title="销售订单排产" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SO.aspx.cs" Inherits="WorkForms_SO" %>
    ...
    <p>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table border="1" cellpadding="0" cellspacing="0" class="style1" frame="Border" width="100%">
                <tr>
                    <td align="center">过滤数据:
                    </td>
                    <td align="center">业务员<asp:DropDownList ID="DropDownList1" runat="server">
                    </asp:DropDownList>
                        制单人<asp:DropDownList ID="DropDownList2" runat="server">
                        </asp:DropDownList>
                        ...
                        <ajaxToolkit:CalendarExtender ID="txtEndDate_CalendarExtender" runat="server" Format="yyyy-MM-dd" TargetControlID="txtEndDate"></ajaxToolkit:CalendarExtender>
                        ...
                        <asp:Button ID="Button112" runat="server" OnClick="Button112_Click" Text="查看缺料（需先选中）" />
                    </td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlFirstDialogBox" runat="server" BorderStyle="Solid" BorderWidth="1" Style="width: 700px; background-color: White; display: none; height: 400px;">
