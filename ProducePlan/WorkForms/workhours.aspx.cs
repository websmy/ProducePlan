...
public partial class WorkForms_workhours : System.Web.UI.Page
{
  ...
  //"where mom_orderdetail.status<> 4 ";   
        ...
        string sql =
            "SELECT   SO_SOMain.cCusName,a.soseq,a.define25,a.SoDId,a.moid,a.SortSeq,Department.[cDepName],a.modid,a.MDeptCode,inventory.cinvdefine4,inventory.[cInvCode],a.SoCode,"
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowIndex > -1)
        {
            ...
            //start
            string tmp = "";
            tmp = "select sum(tworkhours) from [workerhoursEnter] where modid='" + modid.Value + "'";
            ...
            {
                tworkhours = Convert.ToDecimal(dt.Rows[0][0]);
            }           
