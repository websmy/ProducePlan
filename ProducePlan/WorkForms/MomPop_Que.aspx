<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MomPop_Que.aspx.cs" Inherits="WorkForms_MomPop" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#CCCCCC"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="xiancun" HeaderText="现存量(不区分仓库)" DataFormatString="{0:0.00}" />
            </Columns>
            <EmptyDataTemplate>
                没有数据
            </EmptyDataTemplate>
