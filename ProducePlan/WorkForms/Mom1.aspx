...
　　        function openwin2(name, winname, id, iWidth, iHeight, p1, p2, p3, p4, p5, p6, p7, MoId, SortSeq, MoDId, p8, soseq,p9) {
    ...
    <p>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table border="1" cellpadding="0" cellspacing="0" Width="100%" frame="Border">
                <tr>
                    <td align="center">
                        过滤数据:
                    </td>
                    <td align="center">
                        ...
                        <asp:CheckBox ID="CheckBox是否缺料具体查询类别" Text="指定类不缺的选出来"  TextAlign="Left" runat="server" />
                        ...
                        <asp:DropDownList ID="DropDownList逾期原因" runat="server">
                          ...
                          是否领料完成<asp:DropDownList ID="DropDownList是否领料完成" runat="server">
                            ...
                            <asp:ListItem>否</asp:ListItem>
                                                  ...
                                                  制单日期 从<asp:TextBox ID="txtStartDate" runat="server" Width="100">2019-01-01</asp:TextBox>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="班组" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
...
<%--
 <cc1:DateTextBox ID="dateTxtBox" Width="100" Text='<%# Bind("Duedate","{0:yyyy-MM-dd}") %>'
                        ...
                        <asp:TemplateField HeaderText="逾期原因" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ItemStyle-CssClass="hidden1" >
                            <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="逾期原因详细" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ItemStyle-CssClass="hidden1">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="是否缺料">
                            ...
                            <asp:TemplateField HeaderText="是否部分缺料">
                            <ItemTemplate>
                               
                               <asp:HyperLink ID="HyperLink4" runat="server" Text="无权限" />
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:CheckBox runat="server" ID="cbHead" onclick="javascript:selectAll('MainContent_GridView1',this.checked);"></asp:CheckBox>
                            </HeaderTemplate>
                            <ItemTemplate>
