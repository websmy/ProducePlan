<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mom2.aspx.cs" Inherits="WorkForms_Mom2" %>
...
<%--
 <cc1:DateTextBox ID="dateTxtBox" Width="100" Text='<%# Bind("Duedate","{0:yyyy-MM-dd}") %>'
                        ...
                        <asp:TemplateField HeaderText="是否领料" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ItemStyle-CssClass="hidden1">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="是否入库" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ItemStyle-CssClass="hidden1">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="操作" FooterStyle-CssClass="hidden1" HeaderStyle-CssClass="hidden1"
                            ItemStyle-CssClass="hidden1">
                            <ItemTemplate>
