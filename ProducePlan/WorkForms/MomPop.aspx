<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MomPop.aspx.cs" Inherits="WorkForms_MomPop" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                ...
                <asp:HiddenField ID="mom_orderdetailmoid" runat="server" />
                <asp:HiddenField ID="soseq" runat="server" />
